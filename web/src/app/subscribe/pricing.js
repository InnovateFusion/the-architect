      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          {pricing.slice(1).map((e, i) => (
            <div
              key={i}
              className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-500 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white h-fit"
            >
              ...
              <div className="flex justify-center items-baseline my-8">
                <span className="mr-2 text-3xl font-extrabold">
                  {i == 2 ? e.price : x ? "$" + e.priceD : e.priceB + " ETB"}
                </span>
