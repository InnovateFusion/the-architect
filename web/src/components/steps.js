    ...
    <div className="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
      ...
      <div className="flex">
        ...
        <div className="pt-1 pb-8">
          ...
          <p className="text-gray-700 dark:text-gray-400">
            Describe your imagination in words as specific as posible to get the
            most comprehensive design that relates to your needs.
          </p>
        </div>
      </div>
      <div className="flex">
...
export const Step2 = ({ setMessage }) => {
  return (
    <div className="px-4 items-align  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl hover:cursor-pointer">
      ...
      {prompts.map((prompt, i) => (
        <div
          key={i}
          className="grid gap-6 align-center"
