...
class Params(Equatable):
    def __init__(self, message: Message, chat_id: str, user_id: str) -> None:
...
class CreateMessage(UseCase[MessageEntity]):
    ...
    async def __call__(self, params: Params) -> Either[Failure, MessageEntity]:
        return await self.repository.create_message(params.message, params.chat_id, params.user_id)