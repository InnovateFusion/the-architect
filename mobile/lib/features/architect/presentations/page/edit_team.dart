...
class _TeamPageCreateState extends State<TeamPageEdit> {
  ...
  void _selectedUsers(String value) {
    if (selectedUsers.contains(value)) {
      teamBloc.add(TeamLeaveEvent(teamId: widget.team.id, userId: value));
      selectedUsers.remove(value);
    } else {
      teamBloc.add(TeamJoinEvent(teamId: widget.team.id, userId: value));
        ...
        child: BlocBuilder<UserBloc, UserState>(
          builder: (context, state) {
            if (state is UserInitial) {
              ...
              return const TeamCreateShimmer();
              ...
              Row(
                children: [
                  ElevatedButton(
                    ...
                    child: Text(
                      widget.team.creatorId == widget.user.id
                          ? "Update"
                          : "Leave",
                      style: const TextStyle(
                        fontSize: 15,
